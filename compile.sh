#!/bin/bash
gfortran -Wall -Wextra -Wtabs -fPIC -g -fcheck=all -fbacktrace -ffree-line-length-0 cylinder_system.f08 dranxor2.f95 -o cylinder_system_debug.exe #use this one for development
